...
## Come usare il sito
1. Apri https://audioguidaregalbuto.it per iniziare il tour e ascoltare le tappe.
2. Usa la sezione "Mappa" per visualizzare e localizzare le tappe su una cartina interattiva.
3. Cambia lingua dal menu in alto a destra.

## Le tappe del tour
1. Piazza della Repubblica
2. Palazzo Comunale
3. Chiesa Madre di San Basilio
4. Monumento di Riccardo Lombardi
5. Monumento di Don Giuseppe Campione
6. Corso G.F. Ingrassia
7. Chiesa di Santa Maria la Croce
...
Questa licenza richiede che i riutilizzatori diano credito ai creatori e concedano in licenza il materiale modificato con termini identici.
